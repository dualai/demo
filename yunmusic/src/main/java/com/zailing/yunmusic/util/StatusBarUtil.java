package com.zailing.yunmusic.util;
...
import com.zailing.yunmusic.view.StatusBarView;
...
public class StatusBarUtil {
    ...
    public static void setStateBar(Activity activity, View toolBar){
        setStateBar(activity,toolBar,Color.TRANSPARENT);
    }

    public static void setStateBar(Activity activity, View toolBar,int color) {
//问题
