...
import com.zailing.yunmusic.ui.UIUtils;
import com.zailing.yunmusic.ui.ViewCalculateUtil;
import com.zailing.yunmusic.util.StatusBarUtil;
import com.zailing.yunmusic.view.MyNestedScrollView;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        /***
         * recyclerview的内容全部被展开了，如果第一次加载item数量特别多，会很慢
         */
        notifyData();
        postImage();
...
//0  1
    ...
    private void postImage() {
        ...
        Glide.with(this)
                ...
                }).override(UIUtils.getInstance().getWidth(380), UIUtils.getInstance().getHeight(380))
                .into(header_image_item);

        /***
         * 对下载下来的图片进行高斯模糊，赋予大容器当背景
         */
...
//        /***
//         * 如果加了，设定固定高度的recyclerveiw将不能继续向下滚动；
//         */
        // 需加，不然滑动不流畅
