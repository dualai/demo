package com.xzl.demo1.switchcmr;
...
//            Uri mVideoUri = Uri.parse("http://live.hkstv.hk.lxdns.com/live/hks/playlist.m3u8");
            ...
            Uri mVideoUri = Uri.parse(video0);
...
//            Uri mVideoUri = Uri.parse("http://ivi.bupt.edu.cn/hls/cctv1hd.m3u8");
            ...
            String video0 = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "VID_20190420_155901.mp4";
            Uri mVideoUri = Uri.parse(video0);
